...
Based on official IKF Indoor Korfball rules (half court):

| Element | Specification |
|---------|---------------|
| Half Court Size | 20m × 20m |
| Korf Position | Center (10m), 6.67m from end line |
| Penalty Area | Stadium shape, 2.5m radius |
| Free Pass Circle | 2.5m radius from penalty spot |
| Penalty Spot | 2.5m behind korf |

## 👥 Players

- **8 players** (4 attack + 4 defense)
- ⭕ Circle = Male player
